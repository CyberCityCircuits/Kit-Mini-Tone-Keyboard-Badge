...
void check_keyboard(){
  ...
  if (key){
    if (key == '1'){playNote(notes[0],  play, wait); x =   0; light_panel();}
    if (key == '2'){playNote(notes[1],  play, wait); x =  26; light_panel();}
    if (key == '3'){playNote(notes[2],  play, wait); x =  53; light_panel();}
    if (key == '4'){playNote(notes[3],  play, wait); x =  79; light_panel();}
    if (key == '5'){playNote(notes[4],  play, wait); x = 106; light_panel();}
    if (key == '6'){playNote(notes[5],  play, wait); x = 132; light_panel();}
    if (key == '7'){playNote(notes[6],  play, wait); x = 158; light_panel();}
    if (key == '8'){playNote(notes[7],  play, wait); x = 185; light_panel();}
    if (key == '9'){playNote(notes[8],  play, wait); x = 211; light_panel();}
    if (key == 'a'){playNote(notes[9],  play, wait); x = 237; light_panel();}
    if (key == 'b'){playNote(notes[10], play, wait); x = 264; light_panel();}
    if (key == 'c'){playNote(notes[11], play, wait); x = 290; light_panel();}
    if (key == 'd'){playNote(notes[12], play, wait); x = 317; light_panel();}
    if (key == 'e'){playNote(notes[13], play, wait); x = 343; light_panel();}
    if (key == 'f'){playNote(notes[14], play, wait); x = 369; light_panel();}
    if (key == 'g'){playNote(notes[15], play, wait); x = 396; light_panel();}
    if (key == 'h'){playNote(notes[16], play, wait); x = 422; light_panel();}
    if (key == 'i'){playNote(notes[17], play, wait); x = 448; light_panel();}
    if (key == 'j'){playNote(notes[18], play, wait); x = 475; light_panel();}
    if (key == 'k'){playNote(notes[19], play, wait); x = 501; light_panel();}
    if (key == 'l'){playNote(notes[20], play, wait); x = 528; light_panel();}
    if (key == 'm'){playNote(notes[21], play, wait); x = 554; light_panel();}
    if (key == 'n'){playNote(notes[22], play, wait); x = 580; light_panel();}
    if (key == 'o'){playNote(notes[23], play, wait); x = 607; light_panel();}
    if (key == 'p'){playNote(notes[24], play, wait); x = 633; light_panel();}
    if (key == 'q'){playNote(notes[25], play, wait); x = 659; light_panel();}
    if (key == 'r'){playNote(notes[26], play, wait); x = 686; light_panel();}
    if (key == 's'){playNote(notes[27], play, wait); x = 712; light_panel();}
    if (key == 't'){playNote(notes[28], play, wait); x = 739; light_panel();}
